...
// accept an offer is Module 10's. The subject is words this person wrote, because free text of the
...
describe("no button, and no confirmation to wire one to", () => {
  test("the resolver still admits only an unconfirmed classification", () => {
    ...
    // flag opens, the gap answer is where Module 10 should wire its proposal surface.
