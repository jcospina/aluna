...
// surface is Module 10's — `src/pipeline/intent/schema.ts` admits only `requires_confirmation:
// z.literal(false)`. This ending is the first place M10 should wire that surface when it has one.
