...
/**
 * The tier metadata's own subject: not what the snapshot contains, but what it claims
 * about the behavioral work that produced it.
 */
...
/**
 * What a manifest records about itself, beyond the tier.
 */
describe("capability artifact lifecycle — manifest digests and provenance", () => {
