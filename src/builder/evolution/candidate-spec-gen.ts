...
export function buildCandidateSpecPrompt(input: GenerateCandidateSpecInput): string {
  ...
  return [
    ...
    '  - record_not_found, invalid_choice and choice_disabled are platform-owned; never author any of them. Behavior-specific cases beyond the required pair may target any action in tools; keep every "action"/"trigger"/"code" combination unique.',
    "",
    "Field pantry:",
