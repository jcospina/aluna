...
export const FEW_SHOT_DESIGN_EXAMPLES: readonly FewShotDesignExample[] = [
  {
    ...
    previewSamples: [
      {
        ...
        previewInnerHtml: [
          ...
          '<span class="text-bold truncate" style="background-color: var(--sun); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">Field memo</span>',
          '<span class="text-bold" style="background-color: var(--clay); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">research</span>',
          "</div>",
      ...
      },
      {
        ...
        previewInnerHtml: [
          ...
          '<div class="cluster gap-1 text-xs">',
          '<span class="text-bold truncate" style="background-color: var(--sun); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">Interview synthesis</span>',
          '<span class="text-bold" style="background-color: var(--clay); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">patterns</span>',
          "</div>",
    ...
    rendererSource: [
      ...
      '    <div class="cluster gap-1 text-xs">',
      '      <span class="text-bold truncate" style="background-color: var(--sun); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">${source}</span>',
      '      <span class="text-bold" style="background-color: var(--clay); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">${tag}</span>',
      "    </div>",
    ...
    previewSamples: [
      {
        ...
        previewInnerHtml: [
          ...
          '<figure class="media-frame media-frame--square w-full" style="margin: 0; aspect-ratio: 1 / 1; min-height: 12rem; border: var(--line) solid var(--shade);">',
  ...
  },
  {
    ...
    previewSamples: [
      {
        ...
        previewInnerHtml: [
          ...
          '<span class="text-xs text-bold" style="align-self: flex-start; background-color: var(--sky); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">interface research</span>',
          "</div>",
          '<span class="text-sm text-bold" style="background-color: var(--shade); color: var(--ink); border: var(--line) solid var(--shade); padding: var(--space-1) var(--space-1);">later</span>',
          "</div>",
        ].join(""),
      },
      {
        ...
        previewInnerHtml: [
          ...
          '<span class="text-xs text-bold" style="align-self: flex-start; background-color: var(--sky); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">design system</span>',
          "</div>",
          '<span class="text-sm text-bold" style="background-color: var(--shade); color: var(--ink); border: var(--line) solid var(--shade); padding: var(--space-1) var(--space-1);">next</span>',
          "</div>",
        ].join(""),
      },
    ],
    rendererSource: [
      ...
      '      <span class="text-xs text-bold" style="align-self: flex-start; background-color: var(--sky); color: var(--ink); border: var(--line) solid var(--ink); padding: var(--space-1) var(--space-1);">${topic}</span>',
      "    </div>",
      '    <span class="text-sm text-bold" style="background-color: var(--shade); color: var(--ink); border: var(--line) solid var(--shade); padding: var(--space-1) var(--space-1);">${priority}</span>',
      "  </div>`;",
      "}",
      "",
      ESCAPE_HELPER_SOURCE,
