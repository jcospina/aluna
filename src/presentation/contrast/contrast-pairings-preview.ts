...
export const PREVIEW_PAIRINGS: readonly Pairing[] = [
  {
    ...
    sites: [
      ...
      "src/server/dev-surfaces/region-lifecycle-preview.ts § .preview-banner [background]",
      "src/server/dev-surfaces/region-lifecycle-preview.ts § .preview-banner [color]",
      "src/server/dev-surfaces/region-lifecycle-preview.ts § .preview-readout [background]",
      "src/server/dev-surfaces/region-lifecycle-preview.ts § .preview-readout [color]",
      "src/server/dev-surfaces/region-lifecycle-preview.ts § .preview-view [color]",
      "src/server/dev-surfaces/swap-target-preview.ts § .preview-banner [background]",
      "src/server/dev-surfaces/swap-target-preview.ts § .preview-banner [color]",
      "src/server/dev-surfaces/swap-target-preview.ts § .preview-readout [background]",
      "src/server/dev-surfaces/swap-target-preview.ts § .preview-readout [color]",
      "src/server/dev-surfaces/swap-target-preview.ts § .preview-table tr:nth-child(odd) td, .preview-table tr:nth-child(odd) th [background]",
      "src/server/dev-surfaces/swap-target-preview.ts § .preview-view [color]",
      "src/server/dev-surfaces/few-shot-gallery-preview.ts § .gallery-example__notes [color]",
      "src/server/dev-surfaces/few-shot-gallery-preview.ts § .gallery-example__source summary [color]",
      "src/server/dev-surfaces/few-shot-gallery-preview.ts § .preview-banner [background]",
      "src/server/dev-surfaces/few-shot-gallery-preview.ts § .preview-banner [color]",
      "src/server/dev-surfaces/few-shot-gallery-preview.ts § .preview-note [color]",
    ],
  },
  {
    ...
    sites: [
      "src/server/dev-surfaces/few-shot-gallery-preview.ts § .gallery-code [background]",
      "src/server/dev-surfaces/few-shot-gallery-preview.ts § .gallery-code [color]",
      "src/server/dev-surfaces/few-shot-gallery-preview.ts § .gallery-example__layout [color]",
    ],
  },
  {
